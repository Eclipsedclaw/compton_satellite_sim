...
G4VPhysicalVolume* DetectorConstruction::DefineVolumes()
{
  ...
  // ================= 第二层结构: YSO2 + Si + FR4 =================
  // 第二层的起始位置: 基于上一层 FR4 的末端坐标 + 间隙 fGap1
  ...
  // ================= 第三层结构: LYSO + Si + FR4 =================
  // 第三层的起始位置: 基于上一层 FR4 的末端坐标 + 间隙 fGap2
  ...
  // 死区颜色设置 (灰色表示 Si，深绿色表示 FR4)
  auto siVisAtt   = new G4VisAttributes(G4Colour(0.8, 0.8, 0.8)); 
  auto fr4VisAtt  = new G4VisAttributes(G4Colour(1, 0, 0)); 
